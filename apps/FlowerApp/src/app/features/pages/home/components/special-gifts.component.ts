        ...
        this.gifts = [
          {
            ...
            description:
              translations['Best Gifts Shop.Awesome Gifts Box Collectons'],
          },
          {
            id: '1',
            ...
            description:
              translations['Best Gifts Shop.Best Occasion Gifts Collections'],
          },
          {
            id: '2',
            bgImg: '/images/Confetti.png',
            ...
            btnText: translations['Best Gifts Shop.Discover Now'],
            description:
              translations['Best Gifts Shop.Combo Sets Gift Box Up To 50% Off'],
          },
        ];
      });
  }
